...
class FollowerResonators extends Component {
    ...
    render() {
        ...
        let addRoute = `/followerGroups/${this.props.match.params.followerId}/resonators/new`;
        let getEditRoute = id => `/followerGroups/${this.props.match.params.followerId}/resonators/${id}/edit`;
        let showRoute = id => `/followerGroups/${this.props.match.params.followerId}/resonators/${id}/show`;

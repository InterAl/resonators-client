...
export function uploadBase64(followerGroupId, resonatorId, base64) {
    return fetcher.post(`/leader_followers/${followerGroupId}/reminders/${resonatorId}/base64`, {resonatorId, base64})
}
